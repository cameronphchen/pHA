...
plt.errorbar(iter_range ,len(iter_range)*[0.706],\
    len(iter_range)*[0.026]          , label="Neuron HA 9TR"      , markevery=2, linewidth=2, color='k',linestyle='--')
...
plt.legend(loc=1)
plt.text(.12, .05, 'Movie Segment Classification '+str(win_size)+'TR', horizontalalignment='left', verticalalignment='bottom')
