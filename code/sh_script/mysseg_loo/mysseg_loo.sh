  ...
  #submit_long run_exp.py $dataset $nvoxel $nTR mysseg --loo $loo -e 2nd -w $winsize ha 10 1300 --strfresh
    ...
    #submit run_exp.py $dataset $nvoxel $nTR mysseg --loo $loo -e 2nd -w $winsize ppca 10 $nfeat --strfresh    
        ...
        do
            ...
            #submit_long run_exp.py $dataset $nvoxel $nTR mysseg --loo $loo -e 1st -w $winsize pha_em 10 $nfeat -r $rand --strfresh
            #submit_long run_exp.py $dataset $nvoxel $nTR mysseg --loo $loo -e 2nd -w $winsize pha_em 10 $nfeat -r $rand --strfresh
        done
    done
done
